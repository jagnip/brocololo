      ...
      ingredients: [
        {
          ingredient: {
            ...
            category: { id: "ic-meat", name: "Meat & Poultry", sortOrder: 3 },
          },
        ...
        ingredients: [
          {
            ingredient: {
              ...
              supermarketUrl: null,
              unitConversions: [{ unitId: "unit-grams", gramsPerUnit: 1 }],
              category: { id: "ic-produce", name: "Produce", sortOrder: 1 },
            },
            unit: { id: "unit-grams", name: "grams" },
            amount: 200,
          },
        ...
        ingredients: [
          {
            ingredient: {
              ...
              category: { id: "ic-oils", name: "Oils & Vinegars", sortOrder: 7 },
            },
  ...
  it("preserves null amount for ingredients without a fixed quantity", () => {
    const slots = [
      createSlot({
        ...
        ingredients: [
          {
            ingredient: { id: "ing-salt", name: "Salt", icon: null, supermarketUrl: null, unitConversions: [], category: { id: "ic-seasonings", name: "Seasonings", sortOrder: 8 } },
        ...
        ingredients: [
          {
            ingredient: {
              ...
              supermarketUrl: null,
              unitConversions: [],
              category: { id: "ic-seasonings", name: "Seasonings", sortOrder: 8 },
            },
            unit: null,
            amount: null,
          },
        ...
        ingredients: [
          ...
          },
          {
            ingredient: {
              ...
              category: { id: "ic-grains", name: "Grains & Pasta", sortOrder: 5 },
            },
  ...
  it("sorts results alphabetically by ingredient name", () => {
    const slots = [
      createSlot({
        ...
        ingredients: [
          {
            ingredient: { id: "ing-z", name: "Zucchini", icon: "zucchini.svg", supermarketUrl: null, unitConversions: [], category: { id: "ic-produce", name: "Produce", sortOrder: 1 } },
            unit: { id: "unit-pieces", name: "pieces" },
            amount: 1,
          },
          {
            ingredient: { id: "ing-a", name: "Avocado", icon: "avocado.svg", supermarketUrl: null, unitConversions: [], category: { id: "ic-produce", name: "Produce", sortOrder: 1 } },
            unit: { id: "unit-pieces", name: "pieces" },
            amount: 2,
          },
          {
            ingredient: { id: "ing-m", name: "Mango", icon: null, supermarketUrl: null, unitConversions: [], category: { id: "ic-produce", name: "Produce", sortOrder: 1 } },
            unit: { id: "unit-pieces", name: "pieces" },
            amount: 3,
          },
        ],
        ...
        ingredients: [
          ...
          },
          {
            ingredient: {
              ...
              category: { id: "ic-sauces", name: "Sauces & Condiments", sortOrder: 6 },
            },
            unit: { id: "unit-ml", name: "ml" },
            amount: 40,
          },
        ...
        ingredients: [
          {
            ingredient: {
              ...
              supermarketUrl: null,
              unitConversions: [{ unitId: "unit-grams", gramsPerUnit: 1 }],
              category: { id: "ic-dairy", name: "Dairy & Eggs", sortOrder: 2 },
            },
            unit: { id: "unit-grams", name: "grams" },
            amount: 50,
          },
        ...
        ingredients: [
          {
            ingredient: {
              ...
              category: { id: "ic-baking", name: "Baking", sortOrder: 6 },
            },
            unit: { id: "unit-cups", name: "cups" },
            amount: 2,
          },
