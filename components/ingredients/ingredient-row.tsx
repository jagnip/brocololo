...
export function IngredientRow({ ingredient }: IngredientRowProps) {
  ...
  return (
    <li className="group/row flex flex-col gap-item rounded-md border border-border/60 bg-card p-nest transition-colors hover:bg-muted/40 focus-within:bg-muted/40">
