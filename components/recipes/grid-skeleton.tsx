...
export default function GridSkeleton() {
  return (
    <div className="px-gutter pb-gutter w-full grid grid-cols-1 gap-block sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
      {Array.from({ length: 12 }).map((_, i) => (
        ...
        >
          ...
          <div className="space-y-item px-card-x py-card-y">
            <Skeleton className="h-5 w-2/3 rounded-md" />
            <div className="flex items-center gap-tight overflow-hidden whitespace-nowrap">
